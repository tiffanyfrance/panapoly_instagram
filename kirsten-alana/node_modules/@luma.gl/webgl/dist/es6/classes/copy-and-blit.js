...
export function readPixelsToArray(source) {
  ...
  const _getFramebuffer = getFramebuffer(source),
...
export function readPixelsToBuffer(source, _ref2) {
  let _ref2$sourceX = _ref2.sourceX,
  ...
  const _getFramebuffer2 = getFramebuffer(source),
...
export function copyToTexture(source, target) {
  ...
  const _getFramebuffer3 = getFramebuffer(source),
...
export function blit(source, target) {
  let _ref6 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
