...
function parseGLBSync(glb, arrayBuffer) {
  ...
  (0, _core.assert)(isJSONChunk, "JSON chunk format ".concat(glb.jsonChunkFormat));
  ...
  var binChunkStart = glb.jsonChunkByteOffset + (0, _core.padTo4Bytes)(glb.jsonChunkLength);
  ...
  if (glb.hasBinChunk) {
    ...
    (0, _core.assert)(isBinChunk, "BIN chunk format ".concat(glb.binChunkFormat));
