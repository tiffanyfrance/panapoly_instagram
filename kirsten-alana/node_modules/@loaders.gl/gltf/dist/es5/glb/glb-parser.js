  ...
  (0, _createClass2["default"])(GLBParser, [{
    ...
    value: function parseSync(arrayBuffer) {
      ...
      if (this.json === null && this.binaryByteOffset === null) {
        var byteOffset = 0;
        (0, _parseGlb.parseGLBSync)(this, this.glbArrayBuffer, byteOffset, options);
    ...
    value: function getBuffer(glTFAccessor) {
      ...
      (0, _core.assert)(byteLength >= 0 && glTFAccessor.byteOffset + byteLength <= glTFBufferView.byteLength);
