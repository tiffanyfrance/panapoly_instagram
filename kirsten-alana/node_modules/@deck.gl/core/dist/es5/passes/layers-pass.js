  ...
  (0, _createClass2.default)(LayersPass, [{
    ...
    value: function drawLayers(_ref) {
      ...
      viewports.forEach(function (viewportOrDescriptor, i) {
        var viewport = _this.getViewportFromDescriptor(viewportOrDescriptor);

        var view = views && views[viewport.id];
        onViewportActive(viewport);

        var stats = _this.drawLayersInViewport(gl, {
          layers: layers,
          viewport: viewport,
          view: view,
    ...
    value: function drawLayersInViewport(gl, _ref2) {
      ...
      layers.forEach(function (layer, layerIndex) {
        var shouldDrawLayer = _this2.shouldDrawLayer(layer, viewport);
