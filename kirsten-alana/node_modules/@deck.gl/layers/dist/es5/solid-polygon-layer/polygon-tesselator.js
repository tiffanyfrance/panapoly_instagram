...
var PolygonTesselator = function (_Tesselator) {
  ...
  (0, _createClass2.default)(PolygonTesselator, [{
    ...
    key: "_updateIndices",
    value: function _updateIndices(polygon, _ref3) {
      var geometryIndex = _ref3.geometryIndex,
          offset = _ref3.vertexStart,
          indexStart = _ref3.indexStart;
    ...
    value: function _updatePositions(polygon, _ref4) {
      var vertexStart = _ref4.vertexStart,
          geometrySize = _ref4.geometrySize;
